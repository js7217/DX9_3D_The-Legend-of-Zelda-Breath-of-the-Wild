...
CIron_Treasure_Box::CIron_Treasure_Box(LPDIRECT3DDEVICE9 pDevice)
...
CIron_Treasure_Box::CIron_Treasure_Box(const CIron_Treasure_Box & rhs)
...
HRESULT CIron_Treasure_Box::Ready_GameObject_Prototype()
{

	return S_OK;
}

HRESULT CIron_Treasure_Box::Ready_GameObject(void * pArg)
{
...
_int CIron_Treasure_Box::Update_GameObject(const _double & TimeDelta)
{
...
_int CIron_Treasure_Box::LateUpdate_GameObject(const _double & TimeDelta)
{
...
HRESULT CIron_Treasure_Box::Render_GameObject()
{
...
HRESULT CIron_Treasure_Box::Add_Component()
{
	//For NxTransform
	COLL_STATE tState;
...
HRESULT CIron_Treasure_Box::SetUp_ConstantTable(LPD3DXEFFECT pEffect)
{
...
HRESULT CIron_Treasure_Box::Create_Capsule_Coll(NxVec3 nxPos)
{
	return E_NOTIMPL;
}

CDgnObj * CIron_Treasure_Box::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CDgnObj* pInstance = new CIron_Treasure_Box(pDevice);
...
CDgnObj * CIron_Treasure_Box::Clone_GameObject(void * pArg)
{
	CDgnObj* pInstance = new CIron_Treasure_Box(*this);
