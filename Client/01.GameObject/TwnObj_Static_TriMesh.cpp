#include "stdafx.h"
#include "TwnObj_Static_TriMesh.h"

#include "KeyMgr.h"
#include "NxPlayer.h"

CTwnObj_Static_TriMesh::CTwnObj_Static_TriMesh(LPDIRECT3DDEVICE9 pDevice)
	: CDgnObj(pDevice)
{

}

CTwnObj_Static_TriMesh::CTwnObj_Static_TriMesh(const CTwnObj_Static_TriMesh & rhs)
	: CDgnObj(rhs)
{

}

HRESULT CTwnObj_Static_TriMesh::Ready_GameObject_Prototype()
{

	return S_OK;
}

HRESULT CTwnObj_Static_TriMesh::Ready_GameObject(void * pArg)
{	
...
_int CTwnObj_Static_TriMesh::Update_GameObject(const _double & TimeDelta)
{
	...
	m_bDraw = m_pFrustumCom->WorldPt_InFrustum(&vPos, m_pTransform, m_fFrustum);
...
_int CTwnObj_Static_TriMesh::LateUpdate_GameObject(const _double & TimeDelta)
{
...
HRESULT CTwnObj_Static_TriMesh::Render_GameObject()
{
...
HRESULT CTwnObj_Static_TriMesh::Set_FarMeshLoad(const _tchar* pName)
{
	//For.Com_Mesh
...
HRESULT CTwnObj_Static_TriMesh::Set_NxTransform(const _matrix& matWorld)
{
	// For.Com_Transform
	COLL_STATE tState;
	ZeroMemory(&tState, sizeof(COLL_STATE));

	tState.cName = "TwnObj_Static_TriMesh";
...
HRESULT CTwnObj_Static_TriMesh::Add_Component(void * pArg)
{
...
HRESULT CTwnObj_Static_TriMesh::SetUp_ConstantTable(LPD3DXEFFECT pEffect)
{
...
CDgnObj * CTwnObj_Static_TriMesh::Create(LPDIRECT3DDEVICE9 pDevice)
{
	CDgnObj* pInstance = new CTwnObj_Static_TriMesh(pDevice);
...
CDgnObj * CTwnObj_Static_TriMesh::Clone_GameObject(void * pArg)
{
	CDgnObj* pInstance = new CTwnObj_Static_TriMesh(*this);
...
void CTwnObj_Static_TriMesh::Free()
{
