...
class CIron_Treasure_Box : public CDgnObj
{


private:
	explicit CIron_Treasure_Box(LPDIRECT3DDEVICE9 pDevice);
	explicit CIron_Treasure_Box(const CIron_Treasure_Box& rhs);
	virtual ~CIron_Treasure_Box() = default;
public:
